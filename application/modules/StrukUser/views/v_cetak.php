...
position:absolute;z-index:2;left:485px;top:18px;width:21px;height:22px'>
                                            <?= $data->pengirim == "nasabah" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                        ...
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:565px;top:18px;width:21px;height:22px'><?= $data->pengirim == "non nasabah" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- pengirim (non nasabah) -->
                                    </p>
                                    <p>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- sknbi -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:167px;top:40px;width:19px;height:18px'><?= $data->transaksi == "sknbi" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                    </p>
                                    <p>
                                        <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- TT -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:85px;top:40px;width:19px;height:18px'><?= $data->transaksi == "tt" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesaiTT -->
                                    </p>
                                    <p>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- rtgs -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:124px;top:40px;width:19px;height:18px'><?= $data->transaksi == "rtgs" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesairtgs -->
                                    </p>
                                    <p>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- setoran -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:35px;top:40px;width:19px;height:18px'><?= $data->transaksi == "setoran" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- setoranselesai -->
                                        <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- kliring -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:214px;top:40px;width:19px;height:18px'><?= $data->transaksi == "kliring" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                    </p>
                                    <p>
                                        <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        <!-- bank -->
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:300px;top:40px;width:19px;height:18px'><?= $data->transaksi == "bank" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                    </p>
                                    <p>
                                        <!--[if gte vml 1]><v:rect
...
height:23px'><?php echo $data->nik ?></span>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                        ...
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:485px;top:62px;width:21px;height:22px'><?= $data->informasi == "perorangan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- informasi(perorangan) -->
                                    </p>
                                    <p>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                        ...
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:565px;top:62px;width:21px;height:22px'><?= $data->informasi == "perusahaan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- informasi(perusahaan) -->
                                        <!--[if gte vml 1]><v:rect
 ...
 height:15pt;z-index:2'/><![endif]-->
                                        ...
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:657px;top:62px;width:21px;height:22px'><?= $data->informasi == "pemerintah" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- informasi(pemerintahan) -->
                                    </p>
                                    <p>
...
height:19px'><?= $data->metode == "tunai" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesai tunai -->
                                    </p>
                                    <p>
...
height:19px'><?= $data->status_penduduk2 == "penduduk" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                    </p>
                                    <p>
                                        <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->status_penduduk2 == "bukan penduduk" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- status_penduduk2(bukan) -->
                                    </p>
                                    <p>
...
height:20px'><?= $data->penerima == "perusahaan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesaiperusahaan -->
                                    </p>
                                    <p>
...
height:20px'><?= $data->penerima == "pemerintahan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesaipemerintahan -->
                                    </p>
                                    <p>
...
height:19px'><?= $data->metode == "debet" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                    </p>
                                    <p>
                                        <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->sumber == "gaji" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->metode == "cek" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesai metode cek -->
                                        <!--[if gte vml 1]><v:rect
...
height:20px'><?php echo $data->isi_debet ?></span>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                        ...
                                        <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:107px;top:190px;width:22px;height:18px'><?= $data->status_penduduk == "penduduk" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- status penduduk -->
                                    </p>
                                    <p>
...
height:20px'><?= $data->status_penduduk == "bukan penduduk" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                        <![endif]>
                                        <!-- selesai -->
                                    </p>
                                    <p>
...
height:21px'><?= $data->no_rek ?></span>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                    <!-- perorangan -->
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:107px;top:165px;width:22px;height:18px'><?= $data->penerima == "perorangan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesaiperorangan -->
                                </p>
                                <p>
...
height:21px'><?php echo $data->jn_identitas ?></span>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:80px;top:290px;width:21px;height:22px'><?= $data->tujuan_transaksi == "tabungan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi tabungan -->
                                </p>
                                <p>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:175px;top:290px;width:21px;height:22px'><?= $data->tujuan_transaksi == "pembayaran" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi pembayaran -->
                                    <!--[if gte vml 1]><v:rect
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:280px;top:313px;width:21px;height:22px'><?= $data->tujuan_transaksi == "donasi" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi donasi -->
                                </p>
                                <p>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:280px;top:290px;width:21px;height:22px'><?= $data->tujuan_transaksi == "biaya hidup" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi biaya -->
                                    <!--[if gte vml 1]><v:rect
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:80px;top:313px;width:21px;height:22px'><?= $data->tujuan_transaksi == "bisnis" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi bisnis -->
                                    <!--[if gte vml 1]><v:rect
 ...
 height:15pt;z-index:2'/><![endif]-->
                                    ...
                                    <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:175px;top:313px;width:21px;height:22px'><?= $data->tujuan_transaksi == "pembelian barang" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- tujuan transaksi pembelian barang -->
                                </p>
                                <p>
...
height:19px'><?= $data->sumber == "tabungan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                </p>
                                <p>
...
height:19px'><?= $data->sumber == "warisan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesao -->
                                </p>
                                <p>
...
height:19px'><?= $data->sumber == "dana" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                </p>
                                <p>
...
height:19px'><?= $data->sumber == "sumbangan" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->sumber == "hasil" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->sumber == "penjual" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->sumber == "hibah" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!-- selesai -->
                                </p>
                                <p>
...
height:19px'><?= $data->biaya_trans == "tunai" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                </p>
                                <p>
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->biaya_trans == "Debet rekening" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                </p>
                                <p>
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->biaya_bank == "lainnya" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->biaya_bank == "pengirim" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                    <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data->biaya_bank == "penerima" ? "<img src='assets/img/ceklist.png' alt='Image' height='10' width='10'>" : ""  ?></span>
                                    <![endif]>
                                </p>
                                <p>
                                    <!--[if gte vml 1]><v:rect
